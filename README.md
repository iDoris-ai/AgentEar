...
| **M3** 句子级流水线(边出边合成) | ✅ **v0.10.0**,首字起播 3.3–6.9s → **约 2.3–2.6s**,见下 |
...
| **首字起播(v0.10.0 流水线)** | 整句路径 **3.3–6.9s** → 流式 **约 2.3–2.6s**,且不再随回答长度增长 |
...
| | 首字起播 | 说明 |
|---|---|---|
| 整句路径(`--ask --no-stream`) | **3.27 / 4.00 / 6.94 s** | 随回答长度增长 |
| **流式路径(默认)** | **2.27 / 2.29 / 2.60 / 2.61 / 2.78 s** | **不再随长度增长** |
